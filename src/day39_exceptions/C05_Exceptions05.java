...
public class C05_Exceptions05 {
	public static void main(String[] args) {// inner try-catch parent child try-catch
		...
		try {// parent try-catch--> file yerini kontrol ediyor ya evde yoksa hatasini handle
			...
			try {// child try-catch --> file icerigini okuma ve yazdirma islemini 
				   // handle etti
				while ((i = fis.read()) != -1) {// int degeri fis obj read metodu ile 
					                          // atandiginda -1 esit degilse while bodye gir
					System.out.print((char) (i));
				}

			} catch (IOException e) {// I :input O:output
				// e.printStackTrace();//daha cok kullanilir cunku hatanintum verisini verir
