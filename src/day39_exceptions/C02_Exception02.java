...
public class C02_Exception02 {
	...
	public static void main(String[] args) {
		...
		// Java exceptions'ý handle etmek için try catch blogu olusturmus.

		try {
			System.out.println("bolum : " + sayi1 / sayi2);

		} catch (ArithmeticException e) {// try body'sinden muhtemel hata ArithmeticException 
			                             // olarak catch body'a sart olarak yazildi
