...
public class C07_NestedTernary02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Lütfen dikdortgenin kenar uzunluklarýný giriniz");
		
		double sayi1 = scan.nextDouble();
		double sayi2 = scan.nextDouble();
		
		System.out.println(sayi1 <= 0 || sayi2 <= 0 ? "Lütfen geçerli uzunluk giriniz" : 
			sayi1 == sayi2 ? "Kare" : "Kare Deðil");
